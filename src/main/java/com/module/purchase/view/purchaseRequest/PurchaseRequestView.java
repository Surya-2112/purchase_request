...
public class PurchaseRequestView extends VerticalLayout {
    ...
    private void buildUI() {
        ...
        getUI().ifPresent(ui ->
            ...
            // PurchaseRequestForm form =
            //         new PurchaseRequestForm(
      ...
      //  });
        ...
        prFilters =new HorizontalLayout( prIdField,createdByField, departmentField,statusField, search,clear);
